...
namespace TropicalServer.BLL
{
    public class ReportsBLL
    {
        ...
        public DataSet ValidateAccount_BLL(string UserID, string Password)
        {
            return (new ReportsDAL().ValidateAccount(UserID, Password));
        }
        ...
        public DataSet GetEmail_BLL(string userInfo)
        {
            return (new ReportsDAL().GetEmail(userInfo));
        }
